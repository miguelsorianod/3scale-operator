...
func NewActiveDocStatusReconciler(b *reconcilers.BaseReconciler, resource *capabilitiesv1beta1.ActiveDoc, providerAccountHost string, reconcileError error) *ActiveDocStatusReconciler {
